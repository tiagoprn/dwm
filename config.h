...
static Key keys[] = {
	...
	/* description: (dwm) tile layout */ 			{ MODKEY,			XK_t,			setlayout,	{.v = &layouts[0]} },
	/* description: (dwm) bstack layout */ 			{ MODKEY|ShiftMask,		XK_t,			setlayout,	{.v = &layouts[1]} },
	/* description: (dwm) spiral layout */ 			{ MODKEY,			XK_y,			setlayout,	{.v = &layouts[2]} },
	/* description: (dwm) dwindle layout */ 		{ MODKEY|ShiftMask,		XK_y,			setlayout,	{.v = &layouts[3]} },
	/* description: (dwm) deck layout */ 			{ MODKEY,			XK_u,			setlayout,	{.v = &layouts[4]} },
	/* description: (dwm) monocle layout */ 		{ MODKEY|ShiftMask,		XK_u,			setlayout,	{.v = &layouts[5]} },
	/* description: (dwm) centeredmaster layout */ 		{ MODKEY,			XK_i,			setlayout,	{.v = &layouts[6]} },
	/* description: (dwm) centeredfloatingmaster layout */ 	{ MODKEY|ShiftMask,		XK_i,			setlayout,	{.v = &layouts[7]} },
	/* description: (dwm) floating layout */ 		{ MODKEY|ShiftMask,		XK_f,			setlayout,	{.v = &layouts[8]} },
